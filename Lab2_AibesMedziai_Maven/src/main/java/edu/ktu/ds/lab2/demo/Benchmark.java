...
public class Benchmark {
    ...
    public void generateElements() {
        ...
        carSet = generateElements(elementCount);
    }
    ...
    public BstSet<Car> BstRetainAll() {
        BstSet<Car> baseCars = new BstSet<>(Car.byPrice);
        BstSet<Car> setCars = new BstSet<>(Car.byPrice);
        addElements(cars, baseCars);
        addElements(carSet, setCars);
        baseCars.retainAll(setCars);
        return baseCars;
    }

    @org.openjdk.jmh.annotations.Benchmark
    public AvlSet<Car> AvlRetainAll() {
        AvlSet<Car> baseCars = new AvlSet<>(Car.byPrice);
        AvlSet<Car> setCars = new AvlSet<>(Car.byPrice);
        addElements(cars, baseCars);
        addElements(carSet, setCars);
        baseCars.retainAll(setCars);
        return baseCars;
